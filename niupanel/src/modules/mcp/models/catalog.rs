    ...
    pub fn current() -> Self {
        Self {
            ...
            tools: vec![
                ...
                McpToolInfo {
                    name: "system_core_releases",
                    category: "system",
                    description: "读取已安装的 Core 版本与回退状态",
                    permission: "overview:read",
                    destructive: false,
                },
                McpToolInfo {
                    name: "system_web_releases",
                    category: "system",
                    description: "读取已安装的 Web UI 版本与兼容状态",
                    permission: "overview:read",
                    destructive: false,
                },
                McpToolInfo {
                    name: "system_core_update_check",
                    category: "system",
                    description: "检查 Core 在线更新",
                    permission: "overview:read",
                    destructive: false,
                },
                McpToolInfo {
                    name: "system_web_update_check",
                    category: "system",
                    description: "检查 Web UI 在线更新",
                    permission: "overview:read",
                    destructive: false,
                },
            ],
