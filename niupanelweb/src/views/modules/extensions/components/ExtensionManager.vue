<template>
  <div class="mx-auto w-full max-w-[1280px] space-y-4">
        ...
        >
          ...
          <div class="min-w-0 flex-1 md:min-w-[180px]">
            <div class="flex flex-wrap items-center gap-2">
              ...
              <span
                v-if="item.record.manifest.runtime_permissions.includes('network_outbound_all_ports')"
                class="rounded bg-rose-500/10 px-1.5 py-0.5 text-[10px] font-bold text-rose-700 dark:text-rose-300"
              >
                任意端口出站
              </span>
    ...
    <ExtensionManagerDialogs :manager="extensionManager" />
...
import ExtensionManagerDialogs from "./ExtensionManagerDialogs.vue";
...
const {
  ...
  uploading, uploadProgress, uploadLoadedBytes, uploadTotalBytes, formatFileSize,
  cancelPluginUpload, closeInstallDialog, handleInstallDialogVisible,
} = extensionManager;
</script>
