...
"#
    ...
    tags(
        ...
        (name = "Telegram", description = "Telegram Agent transport configuration and connection testing"),
...
#[openapi(
    paths(
        ...
        plugins::handlers::create_plugin_upload_session,
        plugins::handlers::commit_plugin_upload_session,
        plugins::handlers::delete_plugin_upload_session,
        ...
        plugins::handlers::stream_plugin_action,
        plugins::handlers::list_open_plugin_actions,
        plugins::handlers::list_open_plugin_actions_for_plugin,
        plugins::handlers::invoke_open_plugin_action,
        plugins::handlers::stream_open_plugin_action
    ),
    components(schemas(
        ...
        plugins::handlers::PluginUploadSessionResponse,
        ...
        niupanel_plugin::PluginActionManifest,
        niupanel_plugin::PluginActionInvokeRequest,
        niupanel_plugin::PluginActionPlugin,
        niupanel_plugin::PluginActionCaller,
...
#[openapi(
    paths(
        ...
        telegram::handlers::list_telegram_users,
    ...
    components(schemas(
        ...
        telegram::handlers::TelegramChatBindingSchema,
        telegram::handlers::TelegramUserOption,
